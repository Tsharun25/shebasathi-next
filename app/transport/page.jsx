...
export default function Transport() {
  ...
  const book = async () => {
    const res = await fetch("https://shebasathi-backend.onrender.com/api/transport-book", {
      method: "POST",
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div className="mt-8 space-y-3">
        ...
        <button onClick={book}
          className="bg-blue-600 text-white w-full py-2 rounded-lg hover:scale-105 transition">
          বুক করুন
        </button>
      </div>
    </div>
