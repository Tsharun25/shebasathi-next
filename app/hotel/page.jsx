...
export default function Hotel() {
  ...
  const handleBook = async (h, index) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/hotel-book`, {
        method: "POST",
        headers: {
      ...
      alert(data.message || "হোটেল বুকিং সফল ✅");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {list.map((h, i) => {
            const form = forms[i] || {};
            const total =
              Number(h.price || 0) * Number(form.days || 0);
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) => updateForm(i, "people", e.target.value)}
                      className="w-full p-3 border rounded-xl outline-none focus:ring-2 focus:ring-green-300"
                    />
                  </div>
