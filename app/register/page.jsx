...
export default function Register() {
  ...
  return (
    <form className="p-5 max-w-md mx-auto space-y-3" onSubmit={submit}>
      <h2 className="text-xl font-bold">রেজিস্টার</h2>

      <input placeholder="নাম" className="border p-2 w-full"
        onChange={(e)=>setForm({...form,name:e.target.value})} />

      <input placeholder="মোবাইল নাম্বার" className="border p-2 w-full"
        onChange={(e)=>setForm({...form,phone:e.target.value})} />

      <input placeholder="Email (optional)" className="border p-2 w-full"
