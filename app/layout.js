...
export default function RootLayout({ children }) {
    ...
    <html lang="bn">
      <body suppressHydrationWarning={true} className="bg-gray-50">
        <AuthProvider>
          ...
          <div className="bg-green-50 border-b py-2 px-3 text-sm flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2">
  ...
  {/* Bottom group (number + icons) */}
  <div className="flex items-center gap-2">
    <span className="font-medium">01710071135</span>
